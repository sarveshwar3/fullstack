		...
		<div class="row justify-content-center">
			<div class="media-container-column col-lg-8" data-form-type="formoid">
				...
				<form:form  action="${saveURL}" method="POST"
					modelAttribute="customerForm" data-form-title="Mobirise Form">	
					...
					<div class="col-md-4 multi-horizontal" data-for="status">
						<div class="form-group">
							...
							<form:input type="text" class="form-control" path="status"
								data-form-field="ID" required="" placeholder="open"
								id="name-form1-r"  />
						</div>
					</div>
					
					<span class="input-group-btn"><input type = "submit"
						class="btn btn-primary btn-form display-4"/>SEND FORM</span>
				</form:form>
			</div>
		</div>
	</div>
