...
<body>
	<section class="menu cid-qE9E6o5M0s" once="menu" id="menu1-e"
		data-rv-view="4160">
		...
		<nav
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
					<li class="nav-item"><a
						class="nav-link link text-white display-4" href="page4.html">
				...
				<div class="navbar-buttons mbr-section-btn">
					...
					<a class="btn btn-sm btn-primary display-4" href="page6.html">USER
						ISSUE</a> <a class="btn btn-sm btn-primary display-4"
						href="page3.html">SIGN IN</a>
				</div>
			</div>
		</nav>
	</section>
	...
	<section class="engine">
		<a href="https://mobirise.co/c">web site maker</a>
	</section>
	<section class="mbr-section content4 cid-qE9JHiRVpZ" id="content4-p"
		data-rv-view="4155">
		...
		<div class="container">
			<div class="media-container-row">
				<div class="title col-12 col-md-8">
					...
					<h3
						class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5"></h3>
	...
	<section class="testimonials2 cid-qE9ILF0xvV" id="testimonials2-j"
		data-rv-view="4157">
		...
		<div class="container">
			<div class="media-container-row">
				...
				<div class="media-content px-3 align-self-center mbr-white py-2">
					<p class="mbr-text testimonial-text mbr-fonts-style display-7">OWNER
						INFORMATION&nbsp;</p>
					<p class="mbr-author-name pt-4 mb-2 mbr-fonts-style display-7">NAME</p>
					<p class="mbr-author-desc mbr-fonts-style display-7">OWNER</p>
				</div>
			</div>
		</div>
	</section>

	<section class="features16 cid-qE9IhJ79q5" id="features16-g"
		data-rv-view="4162">



		<div class="container align-center">
			<h2 class="pb-3 mbr-fonts-style mbr-section-title display-2">OUR
				AWESOME TEAM</h2>
			<h3
				...
				<div class="team-item col-lg-3 col-md-6">
					...
					<div class="item-caption py-3">
						<div class="item-name px-2">
							<p class="mbr-fonts-style display-5">NAME</p>
						</div>
						...
						<div class="item-social pt-2">
							<a href="https://twitter.com/mobirise" target="_blank"> <span
								class="p-1 socicon-twitter socicon mbr-iconfont mbr-iconfont-social"
								media-simple="true"></span>
							</a> <a
								href="https://www.facebook.com/pages/Mobirise/1616226671953247"
								target="_blank"> <span
								class="p-1 socicon-facebook socicon mbr-iconfont mbr-iconfont-social"
								media-simple="true"></span>
							</a> <a href="https://plus.google.com/u/0/+Mobirise" target="_blank">
								<span
								class="p-1 socicon-googleplus socicon mbr-iconfont mbr-iconfont-social"
								media-simple="true"></span>
							</a> <a href="https://www.linkedin.com/in/mobirise" target="_blank">
								<span
								class="p-1 socicon-linkedin socicon mbr-iconfont mbr-iconfont-social"
								media-simple="true"></span>
							</a> <a href="https://www.instagram.com/mobirise/" target="_blank">
	...
	<section class="cid-qE9IXQuj7a" id="footer2-k" data-rv-view="4174">
		...
		<div class="container">
			<div class="media-container-row content mbr-white">
				<div class="col-12 col-md-3 mbr-fonts-style display-7">
					<p class="mbr-text">
						<strong>Address</strong> <br> <br>1234 Street Name<br>City,
						AA 99999<br> <br> <br>
						<strong>Contacts</strong> <br> <br>Email:
						support@mobirise.com<br>Phone: +1 (0) 000 0000 001<br>Fax:
						+1 (0) 000 0000 002
					</p>
				</div>
				<div class="col-12 col-md-3 mbr-fonts-style display-7">
				...
				<div class="col-12 col-md-6">
					<div class="google-map">
						<iframe frameborder="0" style="border: 0"
							src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJUY9IkBthUjoRdDAzOzWhZZY"
				...
				<div class="media-container-row mbr-white">
					<div class="col-sm-6 copyright">
						<p class="mbr-text mbr-fonts-style display-7">© Copyright 2017
							Sarveshwar- All Rights Reserved</p>
					</div>
					<div class="col-md-6">
